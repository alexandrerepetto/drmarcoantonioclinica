      ...
      <section className="py-20">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-14 items-center max-w-6xl">
          ...
          <div className="grid gap-5">
            <div className="bg-primary-soft rounded-2xl p-6 border border-primary/10">
              <div className="flex items-start gap-4">
                <div className="rounded-xl bg-primary text-primary-foreground p-3"><Target className="h-5 w-5" /></div>
                <div>
                  <h3 className="font-bold font-display text-lg mb-1.5">Missão</h3>
            ...
            <div className="bg-card rounded-2xl p-6 shadow-card border border-border">
              <div className="flex items-start gap-4">
                <div className="rounded-xl bg-accent text-accent-foreground p-3"><Sparkles className="h-5 w-5" /></div>
                <div>
                  <h3 className="font-bold font-display text-lg mb-1.5">Visão</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v) => (
              <div key={v.title} className="bg-card rounded-2xl p-6 border border-border shadow-card">
                ...
                <h3 className="font-bold font-display text-lg mb-2">{v.title}</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {team.map((m) => (
              <div key={m.name} className="group">
                ...
                <h3 className="text-xl font-bold font-display text-foreground">{m.name}</h3>
